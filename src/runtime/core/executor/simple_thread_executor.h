...
public:
  SimpleThreadExecutor() : logger_ptr_(std::make_shared<aimrt::common::util::LoggerWrapper>()) {}
  ...
  bool IsInCurrentExecutor() const noexcept override { return std::this_thread::get_id() == thread_id_; }
