...
#if defined(_WIN32)
        static constexpr WORD color_array[aimrt_log_level_t::AIMRT_LOG_LEVEL_OFF] = {0, CC_DBG, CC_INF, CC_WRN, CC_ERR, CC_FATAL};
...
#else
        static constexpr std::string_view kColorArray[aimrt_log_level_t::AIMRT_LOG_LEVEL_OFF] = {"", CC_DBG, CC_INF, CC_WRN, CC_ERR, CC_FATAL};
