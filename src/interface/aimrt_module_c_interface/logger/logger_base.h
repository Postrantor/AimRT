...
typedef struct {
   ...
   */
  void (*log)(void* impl, aimrt_log_level_t lvl, uint32_t line, uint32_t column, const char* file_name, const char* function_name, const char* log_data, size_t log_data_size);
