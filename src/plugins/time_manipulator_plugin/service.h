...
public:
  ...
  void RegisterTimeManipulatorExecutor(TimeManipulatorExecutor* ptr) { executor_map_.emplace(ptr->Name(), ptr); }
  ...
  Pause(aimrt::rpc::ContextRef ctx_ref, const ::aimrt::protocols::time_manipulator_plugin::PauseReq& req, ::aimrt::protocols::time_manipulator_plugin::CommonRsp& rsp) override;
...
private:
  ...
  static constexpr std::string_view kErrorInfoArray[] = {"", "INVALID_EXECUTOR_NAME"};

  static void SetErrorCode(ErrorCode code, ::aimrt::protocols::time_manipulator_plugin::CommonRsp& rsp) {
